...
class ViewController: UIViewController {
    ...
    //Criando a estrutura do BackGround do projeto
    private lazy var backgroundView: UIImageView = {
        let imageView = UIImageView()
        imageView.contentMode = .scaleAspectFill//Faz com que a imagem se adeque melhor respeitando os tamanhos
        imageView.translatesAutoresizingMaskIntoConstraints = false
        return imageView
    }()
    
    //Criando o primeiro quadrado que aparecerá
    private lazy var headerView: UIView = {
        let view = UIView()
        view.translatesAutoresizingMaskIntoConstraints = false
        view.backgroundColor = UIColor.contrastColor
        view.layer.cornerRadius = 20//fazendo com que o quadrado tenha bordas arredondadas
        return view
    }()
    
    //Label da cidade escolhida para prever o tempo
    ...
    //label que mostra o graus celsius da cidade no momento
    ...
    //Icone que mostra como esta o tempo naquele exato momento
    ...
    //chamando as duas informações que a wind fornece p adiciona-las na stackView
    ...
    private lazy var statsStackView: UIStackView = {
        ...
        stackView.translatesAutoresizingMaskIntoConstraints = false
        stackView.spacing = 3
        stackView.backgroundColor = UIColor.secondColor
    ...
    //chamando a informações para aparecer na tela
